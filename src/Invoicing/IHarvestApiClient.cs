...
public interface IHarvestApiClient
{
    ...
    [Get("/projects")]
    Task<IApiResponse<ProjectList>> GetProjectList([Header(HarvestAccountIdHeaderName)] string accountId,
    ...
    Task<IApiResponse<EntryModel>> GetTimeEntries([Header(HarvestAccountIdHeaderName)] string accountId,
